...
<form action="index.php?controller=Client&action=singInClient" method="POST" id="form" class="formReg">
    ...
    <input type="checkbox" name="formConditions" id="formConditions" required> Estoy de acuerdo con los <a href="#">Terminos y Condiciones</a>
    <input type="submit" value="Registrar" class="formSumbit">
    <p class="formParagraph">¿Ya tienes cuenta? <a href="index.php?controller=Client&action=loginClient"
    class="formLink">Entra aquí</a></p>
